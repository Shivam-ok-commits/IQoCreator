    ...
    <main className="min-h-screen" style={{ background: theme.background }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center">
          ...
          <h1 className="font-display text-heading-2 mb-3" style={{ color: theme.textPrimary }}>Audience Analytics</h1>
          <p className="text-body max-w-md" style={{ color: theme.textSecondary }}>
            Audience analytics coming in V2. This will help you understand viewer
